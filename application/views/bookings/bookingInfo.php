<div class="content-wrapper">
	...
	<div class="row">
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Entrez les détails du réservation : <b><?= $bookingDetails->customerName ?></b> (<?= date('Y-m-d', strtotime($bookingDetails->bookStartDate)) ?> to <?= date('Y-m-d', strtotime($bookingDetails->bookEndDate)) ?>)</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="editOldBooking" action="<?php echo base_url() ?>booking/updateOldBooking" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="sizeId">Taille du Piéce</label>
                                        <select class="form-control" id="sizeId" name="sizeId">
                                            <option value="">Select Taille du Piéce</option>
                                            <?php
                                            if(!empty($roomSizes))
                                            {
            ...
            <div class="col-md-4">
                <div id="validationDiv" style='display:none'><div class="box box-primary"><div class="box-body"><div class="row"><div class="col-md-12"><div class="callout callout-danger"><h4>Impossible de vérifier!</h4><p id='dateValidationMsg'></p></div></div></div></div></div></div>
